...
class ManagerController extends Controller { 
	...
	public function tickets_post() {
		...
		$request = new Request('POST', array('ticket_id','ticket_new','ticket_user','ticket_code','ticket_updated','ticket_deleted'));
		...
		if(!$this->has_errors()) {
			...
			if($assigned_ticket && !$ticket_delete)
				$ticket_html = View::make('/manager/ticket.php')->with(array('ticket' => $assigned_ticket))->render();
